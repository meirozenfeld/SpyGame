...
source.include_exts = py,png,jpg,kv,atlas,txt,words.txt,mp3,end_sound.mp3,images/*
...
requirements = python3,kivy==2.2.1,jnius==2.0.4 kivy.deps.sdl2,kivy.deps.glew,kivy.deps.gstreamer,kivy.deps.angle,sdl2_ttf==2.0.15,sdl2_image==2.0.5,sdl2_mixer==2.0.5,pillow,openjdk-8
