...
source.include_exts = py,png,jpg,kv,atlas,txt,words.txt,mp3,end_sound.mp3,images/*,json,ttf
...
requirements = python3,kivy==2.3.0,openssl==1.1.1i,firebase_admin,pillow
